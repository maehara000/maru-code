...
$Referer_check_domain = "maru-code.com";
...
$refrom_name = "maru-code.com";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "お問い合わせが無事送信されました";
...
──────────────────────
webコーディング専門事務所「marucode」
代表：前原 奨
E-mail:info@maru-code.com
URL: https://maru-code.com
──────────────────────
